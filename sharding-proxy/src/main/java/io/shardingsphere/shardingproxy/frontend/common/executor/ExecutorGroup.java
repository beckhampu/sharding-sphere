...
public final class ExecutorGroup {
    ...
    public ExecutorService getExecutorService() {
        return TransactionType.XA == GLOBAL_REGISTRY.getTransactionType() ? ChannelThreadExecutorGroup.getInstance().get(channelId) : ShardingProxy.getInstance().getUserGroup();
    }
}
