...
public final class ComStmtExecutePacket implements QueryCommandPacket {
    ...
    public ComStmtExecutePacket(
            final int sequenceId, final String currentSchema, final MySQLPacketPayload payload, final BackendConnection backendConnection) throws SQLException {
        ...
        backendHandler = BackendHandlerFactory.newBinaryProtocolInstance(sequenceId, binaryStatement.getSql(), parameters, backendConnection, DatabaseType.MySQL, currentSchema);
    }
