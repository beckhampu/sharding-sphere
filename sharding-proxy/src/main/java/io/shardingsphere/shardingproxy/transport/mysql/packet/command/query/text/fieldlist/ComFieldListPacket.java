...
public final class ComFieldListPacket implements CommandPacket {
    ...
    public ComFieldListPacket(final int sequenceId, final String currentSchema, final MySQLPacketPayload payload, final BackendConnection backendConnection) {
        this.sequenceId = sequenceId;
        this.currentSchema = currentSchema;
        table = payload.readStringNul();
        fieldWildcard = payload.readStringEOF();
        backendHandler = BackendHandlerFactory.newTextProtocolInstance(sequenceId, String.format(SQL, table, currentSchema), backendConnection, DatabaseType.MySQL, currentSchema);
    }
