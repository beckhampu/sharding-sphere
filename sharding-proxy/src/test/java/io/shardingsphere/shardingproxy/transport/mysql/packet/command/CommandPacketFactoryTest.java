...
public final class CommandPacketFactoryTest {
    ...
    public void assertNewInstanceWithComQuitPacket() throws SQLException {
        ...
        assertThat(CommandPacketFactory.newInstance(1, payload, backendConnection, frontendHandler), instanceOf(ComQuitPacket.class));
    }
    ...
    public void assertNewInstanceWithComInitDbPacket() throws SQLException {
        ...
        assertThat(CommandPacketFactory.newInstance(1, payload, backendConnection, frontendHandler), instanceOf(ComInitDbPacket.class));
    }
    ...
    public void assertNewInstanceWithComFieldListPacket() throws SQLException {
        ...
        assertThat(CommandPacketFactory.newInstance(1, payload, backendConnection, frontendHandler), instanceOf(ComFieldListPacket.class));
    }
    ...
    public void assertNewInstanceWithComQueryPacket() throws SQLException {
        ...
        assertThat(CommandPacketFactory.newInstance(1, payload, backendConnection, frontendHandler), instanceOf(ComQueryPacket.class));
    }
    ...
    public void assertNewInstanceWithComStmtPreparePacket() throws SQLException {
        ...
        assertThat(CommandPacketFactory.newInstance(1, payload, backendConnection, frontendHandler), instanceOf(ComStmtPreparePacket.class));
    }
    ...
    public void assertNewInstanceWithComStmtExecutePacket() throws SQLException {
        ...
        assertThat(CommandPacketFactory.newInstance(1, payload, backendConnection, frontendHandler), instanceOf(ComStmtExecutePacket.class));
    }
    ...
    public void assertNewInstanceWithComStmtClosePacket() throws SQLException {
        ...
        assertThat(CommandPacketFactory.newInstance(1, payload, backendConnection, frontendHandler), instanceOf(ComStmtClosePacket.class));
    }
    ...
    public void assertNewInstanceWithComPingPacket() throws SQLException {
        ...
        assertThat(CommandPacketFactory.newInstance(1, payload, backendConnection, frontendHandler), instanceOf(ComPingPacket.class));
    }
    ...
    public void assertNewInstanceWithComSleepPacket() throws SQLException {
        ...
        assertThat(CommandPacketFactory.newInstance(1, payload, backendConnection, frontendHandler), instanceOf(UnsupportedCommandPacket.class));
    }
